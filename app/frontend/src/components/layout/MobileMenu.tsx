...
export const Header: React.FC = () => {
  ...
  return (
    <>
      {/* ── HEADER BAR (desktop + mobile top bar) ─────────────────────── */}
      <header
      ...
      >
        {/* Backdrop */}
        <div
          className="fixed inset-0 top-16 bg-slate-950/60 backdrop-blur-sm -z-10"
          onClick={() => setMobileOpen(false)}
          aria-hidden="true"
        />

        {/* Menu panel */}
        <div className="bg-slate-950 border-b border-slate-800/80 shadow-2xl shadow-black/40 max-h-[calc(100vh-4rem)] overflow-y-auto">
