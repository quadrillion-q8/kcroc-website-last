...
import {
  ...
  MessageCircle, HelpCircle, ShieldCheck, Cpu, Wrench, Droplets, Activity, Phone
} from 'lucide-react';
  ...
  return (
    <main className="w-full min-h-screen bg-transparent text-slate-200 selection:bg-cyan-500/30 pt-32 pb-24">
      <Helmet>
        ...
        <meta name="description" content="Expert Apple MacBook repair in Kuwait. Logic board micro-soldering, liquid damage recovery, and data preservation. No Fix, No Charge." />
        <link rel="canonical" href={`${BUSINESS_INFO.url}/macbook-repair-kuwait`} />
