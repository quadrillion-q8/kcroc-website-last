...
const FAQS = [
  {
    q: "Do you offer free pickup and delivery in Kuwait?",
    a: "Yes, we offer completely free pickup and delivery across all governorates in Kuwait, including Hawalli, Salmiya, and Kuwait City."
  },
  {
    q: "What is your turnaround time for repairs?",
    a: "Most diagnostic assessments are completed the same day. Standard repairs like screen or battery replacements take 24–48 hours."
  },
  {
    q: "Do I pay if my computer cannot be fixed?",
    a: "No. We operate on a strict No Fix, No Fee policy. If we cannot repair your device, you pay absolutely nothing."
  },
  {
    q: "Do you provide a warranty on repairs?",
    a: "Yes, all hardware repairs and replacement parts come with a 30-day warranty."
  }
];
  ...
  return (
    <div className="border border-slate-800/80 rounded-2xl overflow-hidden bg-slate-900/30 backdrop-blur-sm mb-3 transition-colors hover:border-slate-700">
      ...
      >
        ...
        <ChevronDown
          size={18}
          className={`text-cyan-400 transition-transform duration-300 shrink-0 ${open ? 'rotate-180' : ''}`}
          aria-hidden="true"
        />
      </button>
      <div
...
const FinalCTASection = () => (
  <section className="relative py-24 px-6 border-t border-slate-800/50 flex justify-center overflow-hidden bg-slate-900/10">
    <div
      className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-cyan-900/20 blur-[100px] rounded-full pointer-events-none"
      aria-hidden="true"
    />
    <div className="w-full max-w-4xl text-center relative z-10">
      <h2 className="text-4xl md:text-5xl font-black mb-6 text-white tracking-tight">
        Hardware Failing?{' '}
        <span className="text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.3)]">We Can Fix It.</span>
      </h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <a 
          ...
          aria-label="Call KCROC support"
          className="flex items-center justify-center gap-3 bg-slate-900/80 backdrop-blur-md border border-slate-700/50 hover:bg-slate-800 text-white font-bold rounded-full px-8 py-4 text-sm uppercase tracking-wider transition-all hover:border-cyan-500/30"
        >
        ...
        <a 
          ...
          aria-label="WhatsApp KCROC for free pickup"
          className="flex items-center justify-center gap-3 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-black rounded-full px-8 py-4 text-sm uppercase tracking-wider transition-all shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:scale-[1.02]"
        >
    ...
    <>
      ...
      <main className="w-full bg-transparent text-white font-sans pb-24 md:pb-0 overflow-x-hidden selection:bg-cyan-500/30">
        ...
        <div
          ...
          className={`fixed bottom-0 left-0 right-0 bg-slate-950/90 backdrop-blur-xl border-t border-slate-800/80 p-4 flex justify-center gap-3 z-50 md:hidden transition-transform duration-500 ${
        ...
        >
          <a 
            ...
            className="flex-1 bg-cyan-500 py-3 rounded-xl text-slate-950 font-black text-center text-sm shadow-[0_0_15px_rgba(6,182,212,0.3)] tracking-wider uppercase flex items-center justify-center gap-2"
          >
            WhatsApp
          </a>
          <a 
            href={`tel:${BUSINESS_INFO.phone}`}
            tabIndex={showStickyCTA ? 0 : -1}
            className="flex-1 bg-slate-900 border border-slate-700 py-3 rounded-xl text-white font-bold text-center text-sm tracking-wider uppercase flex items-center justify-center gap-2"
          >
            Call Lab
          </a>
        </div>
