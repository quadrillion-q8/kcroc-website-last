...
const trustPoints = [
  {
    icon: BadgeCheck,
    title: 'No Fix, No Fee',
    description: 'You only pay if we successfully repair your device. Zero risk, full transparency.',
  },
  {
    icon: Zap,
    title: 'Same-Day Service',
    description: 'Most repairs completed the same day. We know your device is essential.',
  },
  {
    icon: RefreshCcw,
    title: '30-Day Warranty',
    description: 'Every repair is backed by a 30-day parts and labour warranty.',
  },
  {
    icon: Truck,
    title: 'Free Pickup & Delivery',
    description: 'We collect and return your device anywhere across all Kuwait governorates.',
  },
];
...
const steps = [
  {
    ...
    description: 'Describe your issue via call or WhatsApp. We respond fast and schedule free pickup at your convenience.',
  },
  {
    icon: Wrench,
    step: '02',
    title: 'Diagnose & Repair',
    description: 'Our technicians run full hardware diagnostics and carry out the repair — chip-level or component replacement.',
  },
  {
    icon: Truck,
    step: '03',
    title: 'Free Delivery Back',
    description: 'Your repaired device is delivered back to you, same day when possible, with a 30-day warranty.',
  },
];
...
const faqs = [
  {
    question: 'Do you offer free pickup anywhere in Kuwait?',
    answer: 'Yes. We offer free pickup and delivery across all six Kuwait governorates — Hawalli, Capital, Farwaniya, Ahmadi, Jahra, and Mubarak Al-Kabeer.',
  },
  {
    question: 'What happens if you can\'t fix my device?',
    answer: 'Our No Fix, No Fee guarantee means you pay nothing if we cannot repair your device. We will return it to you at no charge.',
  },
  {
    question: 'How long does a typical repair take?',
    answer: 'Most software issues, screen replacements, and SSD upgrades are completed same day. Complex chip-level or motherboard repairs typically take 1–3 business days.',
  },
  {
    question: 'Do you repair all laptop brands?',
    answer: 'Yes — MacBook, Dell, HP, Lenovo, ASUS, Acer, MSI, Razer, Alienware, and more. We handle consumer laptops, gaming rigs, and professional workstations.',
  },
  {
    question: 'Is there a warranty on repairs?',
    answer: 'All repairs carry a 30-day warranty covering both parts and labour. If the same fault returns within 30 days, we fix it at no extra cost.',
  },
  {
    question: 'Where is your workshop located?',
    answer: 'Hawalli, Ibn Khaldoun St, Al Mullah Complex, Basement Shop 19, Kuwait. But most customers never need to visit — we come to you.',
  },
];
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      (entries) => { if (entries[0].isIntersecting) setStatsAnimated(true); },
      { threshold: 0.5 }
    );
    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans">
      ...
      <section className="pt-32 pb-20 px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-green-500 px-8 py-4 rounded-full font-bold text-lg hover:bg-green-600 transition-all shadow-lg hover:shadow-green-500/20"
          >
            <MessageCircle className="h-5 w-5" /> WhatsApp Us
          </a>
          <a
            href="tel:+96555301913"
            className="flex items-center justify-center gap-2 bg-gray-800 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-700 transition-all border border-gray-700"
          >
      ...
      <section ref={statsRef} className="py-12 max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 px-6">
        <div className="bg-gray-900/40 p-6 rounded-2xl border border-gray-800 text-center hover:border-emerald-500/30 transition-colors">
          ...
          <div className="text-xs text-gray-400 uppercase tracking-widest mt-2">Google Rating</div>
        </div>
        <div className="bg-gray-900/40 p-6 rounded-2xl border border-gray-800 text-center hover:border-emerald-500/30 transition-colors">
          <div className="text-4xl font-black text-white">
            <Counter end={150} suffix="+" animated={statsAnimated} />
          </div>
          <div className="text-xs text-gray-400 uppercase tracking-widest mt-2">Verified Reviews</div>
        </div>
        <div className="bg-gray-900/40 p-6 rounded-2xl border border-gray-800 text-center hover:border-emerald-500/30 transition-colors">
          <div className="text-4xl font-black text-white">Free</div>
          <div className="text-xs text-gray-400 uppercase tracking-widest mt-2">Pick &amp; Drop</div>
        </div>
        <div className="bg-gray-900/40 p-6 rounded-2xl border border-gray-800 text-center hover:border-emerald-500/30 transition-colors">
          <div className="text-4xl font-black text-white">30 Days</div>
          <div className="text-xs text-gray-400 uppercase tracking-widest mt-2">Warranty</div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <Link
              key={i}
              to={s.path}
              className="bg-gray-900/30 p-8 rounded-3xl border border-gray-800 hover:border-emerald-500/50 hover:bg-gray-900/60 transition-all group"
            >
      ...
      <section className="py-20 bg-gray-900/30 border-y border-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {trustPoints.map((t, i) => (
              <div key={i} className="bg-gray-950/60 p-8 rounded-3xl border border-gray-800 hover:border-emerald-500/30 transition-colors text-center">
      ...
      <section className="py-20 max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-10 left-1/4 right-1/4 h-px bg-gradient-to-r from-emerald-500/0 via-emerald-500/40 to-emerald-500/0 pointer-events-none" />
          {steps.map((s, i) => (
            <div key={i} className="relative flex flex-col items-center text-center p-8 rounded-3xl border border-gray-800 bg-gray-900/30 hover:border-emerald-500/30 transition-colors">
      ...
      <section className="py-20 bg-gray-900/30 border-y border-gray-800">
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-4xl font-bold text-center">Areas We Serve</h2>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {areas.map((area, i) => (
              <span
                key={i}
                className="px-4 py-2 rounded-full text-sm font-medium bg-gray-900/60 border border-gray-700 text-gray-300 hover:border-emerald-500/40 hover:text-emerald-400 transition-colors cursor-default"
              >
                {area}
              </span>
            ))}
          ...
          <p className="text-center text-gray-500 text-sm mt-8">
            Don't see your area?{' '}
            <a href="https://wa.me/96555301913" className="text-emerald-400 hover:underline">
              WhatsApp us
            </a>{' '}
      ...
      <section className="py-20 max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {reviews.map((r, i) => (
            <div key={i} className="bg-gray-900/40 p-8 rounded-3xl border border-gray-800 flex flex-col h-full hover:border-gray-700 transition-colors">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-emerald-500/10 to-gray-900/0 border border-emerald-500/20 rounded-3xl p-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="https://wa.me/96555301913"
              className="flex items-center justify-center gap-2 bg-green-500 px-8 py-4 rounded-full font-bold text-lg hover:bg-green-600 transition-all shadow-lg hover:shadow-green-500/30"
            >
