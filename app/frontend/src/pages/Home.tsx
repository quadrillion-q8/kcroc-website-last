...
export default function Home() {
  ...
  return (
    <div className="w-full bg-[#0a0f1c] flex flex-col items-center overflow-x-hidden pb-24 md:pb-0 selection:bg-cyan-500/30">
      ...
      <section className="relative w-full pt-32 pb-20 flex flex-col items-center px-6 min-h-[90vh] justify-center overflow-hidden">
        ...
        <div className="relative w-full max-w-3xl text-center z-10 flex flex-col items-center mt-8">
          <FadeIn>
            ...
            <div className="flex items-center gap-2 justify-center mt-8 p-4 bg-slate-900/40 border border-slate-800 rounded-full w-fit mx-auto backdrop-blur-md">
      ...
      {/* Trust Stats Section */}
      <section className="w-full py-16 flex justify-center px-6 border-t border-slate-800/50 bg-slate-900/10">
      ...
      <section className="w-full py-12 flex justify-center px-6 text-center bg-slate-900/20 border-t border-slate-800/50 backdrop-blur-sm">
        <div className="w-full max-w-4xl">
          ...
          <p className="text-slate-400 text-sm">Looking for specialised repairs? Explore our 
            <Link to="/motherboard-repair-kuwait" className="text-cyan-400 hover:text-cyan-300 hover:underline mx-1 transition-colors">Motherboard Repair</Link>, 
            <Link to="/macbook-repair-kuwait" className="text-cyan-400 hover:text-cyan-300 hover:underline mx-1 transition-colors">MacBook Repair</Link>, and 
            <Link to="/laptop-screen-repair-kuwait" className="text-cyan-400 hover:text-cyan-300 hover:underline mx-1 transition-colors">Laptop Screen Repair</Link> services.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s, idx) => (
              <FadeIn key={s.path} delay={idx * 50}>
                <Link to={s.path} className="group block bg-slate-900/30 backdrop-blur-sm p-8 rounded-3xl border border-slate-800 hover:border-cyan-500/40 transition-all duration-300 h-full hover:shadow-[0_0_30px_rgba(34,211,238,0.05)]">
      ...
      {/* Reviews Section */}
      <section className="w-full py-24 flex justify-center px-6 border-t border-slate-800/50 bg-slate-900/10">
        <div className="w-full max-w-7xl">
            ...
            {reviews.map((review, idx) => (
              <FadeIn key={idx} delay={idx * 50}>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block bg-slate-900/30 backdrop-blur-sm p-8 rounded-3xl border border-slate-800 hover:border-cyan-500/40 transition-all duration-300 h-full hover:shadow-[0_0_30px_rgba(34,211,238,0.05)]"
                >
      ...
      {/* Areas Section */}
      <section className="w-full py-16 border-y border-slate-800/50 flex justify-center px-6 text-center bg-slate-900/20 backdrop-blur-sm">
        <div className="w-full max-w-4xl">
      ...
      <section className="w-full py-20 bg-slate-900/10 border-t border-slate-800/50 flex justify-center px-6">
        <div className="w-full max-w-4xl">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-slate-950/90 backdrop-blur-xl border-t border-slate-800/80 p-4 flex justify-center gap-3 z-50 md:hidden">
        <a href={waLink} target="_blank" rel="noopener noreferrer" className="flex-1 bg-cyan-500 py-3 rounded-xl text-slate-950 font-black text-center text-sm shadow-[0_0_15px_rgba(6,182,212,0.3)] tracking-wider uppercase flex items-center justify-center gap-2">
          <MessageCircle className="w-4 h-4" /> Chat
        </a>
        <a href={`tel:${cleanPhoneStr}`} className="flex-1 bg-slate-900 border border-slate-700 py-3 rounded-xl text-white font-bold text-center text-sm tracking-wider uppercase flex items-center justify-center gap-2">
          <Phone className="w-4 h-4 text-cyan-400" /> Call Lab
        </a>
      </div>
