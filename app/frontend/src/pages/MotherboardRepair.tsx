...
const FAQS = Object.freeze([
  ...
  { q: "How long does it take to repair a laptop motherboard?",     a: "Standard component-level diagnostics take 24 hours. Full micro-soldering repair and thermal stress testing usually require 2 to 4 business days. We offer free pickup and delivery to expedite the process." },
  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Motherboard Repair", "item": PAGE_URL }
      ]
    }
  ]
};
  ...
  return (
    <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800 rounded-3xl p-8 shadow-xl transition-all duration-300">
      ...
      <div className="space-y-4">
        {[
          { field: 'noPower',   label: 'Device shows zero power lights when plugged in.' },
          { field: 'noDisplay', label: 'Fans spin, but screen remains completely black.' },
          { field: 'spill',     label: 'Machine suffered a liquid spill or extreme condensation.' },
        ].map(({ field, label }) => (
          <label key={field} className="flex items-start gap-3 cursor-pointer text-sm text-slate-300 group">
            <input
              type="checkbox"
              onChange={(e) => setState(prev => ({ ...prev, [field]: e.target.checked }))}
              className="mt-1 accent-cyan-500 w-4 h-4 rounded border-slate-700 bg-slate-950 transition-colors"
            />
      ...
      {triggerWarning && (
        <div
          role="alert"
          className="mt-6 bg-red-500/10 border border-red-500/30 rounded-xl p-4 text-sm text-red-400 flex items-start gap-3 animate-in fade-in slide-in-from-bottom-2 duration-300"
        >
...
export default function MotherboardRepair() {
  ...
  return (
    <main className="w-full min-h-screen bg-transparent text-slate-200 selection:bg-cyan-500/30 pt-32 pb-24 font-sans">
      ...
      <section className="relative px-6 text-center z-10 mb-24">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 tracking-tight leading-tight">
            Motherboard Repair<br className="hidden md:block" /> in{' '}
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-8">
            ...
            >
              Book Free Diagnostic <ExternalLink size={20} aria-hidden="true" />
            </a>
          ...
          <div className="flex justify-center gap-6 mt-8 text-sm text-slate-400 font-bold uppercase tracking-widest">
            <span className="flex items-center gap-2">
              <ShieldCheck size={16} className="text-emerald-400" aria-hidden="true" /> No Fix, No Charge
            </span>
            <span className="flex items-center gap-2">
              <MapPin size={16} className="text-emerald-400" aria-hidden="true" /> Serving All Kuwait
            </span>
          </div>
        </div>
      </section>
      ...
      <article className="max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-12 gap-12 relative z-10">
        ...
        <div className="lg:col-span-8 space-y-24">
          ...
          <section aria-labelledby="awareness-heading">
            <h2 id="awareness-heading" className="text-3xl font-black text-white mb-6">Why is my laptop not turning on?</h2>
          ...
          <section aria-labelledby="tools-heading">
            <h2 id="tools-heading" className="text-3xl font-black text-white mb-8">How We Diagnose Dead Motherboards</h2>
              ...
              {DIAGNOSTIC_TOOLS.map((tool) => (
                <div key={tool.id} className="bg-slate-900/30 backdrop-blur-md border border-slate-800 rounded-3xl p-8 hover:border-cyan-500/30 transition-all">
                  <h3 className="text-lg font-black text-white mb-3 flex items-center gap-3">
                    <tool.icon size={20} className="text-cyan-400" aria-hidden="true" /> {tool.name}
                  </h3>
          ...
          <section aria-labelledby="failures-heading">
            <h2 id="failures-heading" className="text-3xl font-black text-white mb-6">Common Logic Board Failures in Kuwait</h2>
            ...
            <div className="space-y-6">
              {BRAND_FAILURES.map((item) => (
                <div key={item.brand} className="bg-slate-900/30 backdrop-blur-md border border-slate-800 rounded-3xl p-8 md:flex justify-between items-center gap-6 hover:border-cyan-500/30 transition-all">
                  <div>
          ...
          <section aria-labelledby="matrix-heading">
            <h2 id="matrix-heading" className="text-3xl font-black text-white mb-6">Can a motherboard be repaired instead of replaced?</h2>
          ...
          <div className="bg-slate-900/30 backdrop-blur-md border border-slate-800 rounded-3xl p-8 shadow-xl">
            ...
            <div className="flex flex-col gap-3">
              <Link
                ...
                className="group flex items-center justify-between p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-cyan-500/50 transition-all text-sm font-bold text-slate-300"
              >
                MacBook Logic Board Repair
                <ArrowRight size={16} className="text-slate-600 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" aria-hidden="true" />
              </Link>
              <Link
      ...
      {/* ─── FAQ SECTION ─── */}
      <section aria-labelledby="faq-heading" className="max-w-3xl mx-auto px-6 relative z-10 mb-24 mt-10">
        <div className="text-center mb-12">
          <h2 id="faq-heading" className="text-3xl font-black text-white mb-4">Common Motherboard Repair Questions</h2>
      ...
      <section aria-labelledby="cta-heading" className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="bg-gradient-to-br from-cyan-900/40 to-slate-900/80 backdrop-blur-xl p-10 md:p-16 rounded-3xl border border-cyan-500/30 text-center shadow-[0_0_40px_rgba(34,211,238,0.1)]">
          <h2 id="cta-heading" className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tight">
            Don't Work Through a Dead Laptop.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              Book Free Diagnostic Pickup <ExternalLink size={20} aria-hidden="true" />
            </a>
