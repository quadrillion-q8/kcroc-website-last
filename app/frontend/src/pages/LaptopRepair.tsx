...
const COMMON_ISSUES = [
  {
    ...
    desc: "Fans running loud? Laptops overheating in Kuwait's climate will damage the CPU. We apply premium thermal paste and clean exhaust vents.",
  ...
  {
    title: "Physical Chassis Damage",
    desc: "Broken hinges or cracked screen bezels? We fabricate and repair plastic mounts to restore structural integrity.",
    icon: Wrench
  },
  {
    title: "BIOS & Firmware Issues",
    desc: "System stuck in a boot loop or corrupted update? We provide advanced BIOS flashing and firmware restoration.",
    icon: Zap
  },
  {
    title: "Screen Replacements",
    desc: "Cracked or flickering display? We install factory-grade OEM replacement panels with zero dead-pixel guarantees.",
    icon: Laptop
  }
];
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Kuwait Computer Repair On Call provides free pick & drop across all of Kuwait. Contact us on WhatsApp or call 55301913 to arrange collection."
          }
        },
        {
          "@type": "Question",
    ...
    <main className="w-full min-h-screen bg-transparent text-slate-200 selection:bg-cyan-500/30 pt-32 pb-24">
      ...
      <section className="relative px-6 text-center z-10 mb-24">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto mb-10">
            From shattered chassis hinges to complex component-level micro-soldering. We restore your laptop to factory performance with free pick & drop and our No Fix, No Fee guarantee.
          </p>
      ...
      <section aria-labelledby="issues-heading" className="max-w-6xl mx-auto px-6 relative z-10 mb-24">
        <div className="text-center mb-12">
          <h2 id="issues-heading" className="text-3xl font-black text-white mb-4">Hardware Failures We Fix</h2>
          <p className="text-slate-400">Professional diagnostics and repair for every component.</p>
        </div>
            ...
            {[
              {
                ...
                desc: "Our driver collects your laptop anywhere in Kuwait. We perform a full teardown and component-level diagnostic test at absolutely no cost to you."
              },
              {
                step: "2",
              ...
              },
              {
                ...
                desc: "We repair the fault, apply high-grade thermal paste, and stress-test the machine before securely delivering it back to your location."
              }
            ].map(({ step, title, desc }) => (
          ...
          {[
            {
              ...
              a: "Yes. We provide free pick & drop across all of Kuwait. Contact us on WhatsApp or call 55301913 to arrange a rapid collection."
            },
            {
              q: "What is your No Fix, No Fee policy?",
              a: "If we cannot repair your laptop, you pay nothing. We return your device at absolutely no charge."
            },
            {
              q: "Which laptop brands do you repair?",
              a: "We perform hardware repair and micro-soldering on all major Windows laptop brands including Dell, HP, Lenovo, ASUS, and Acer."
            }
          ].map(({ q, a }) => (
      ...
      <section aria-labelledby="cta-heading" className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="bg-gradient-to-br from-cyan-900/40 to-slate-900/80 backdrop-blur-xl p-10 rounded-3xl border border-cyan-500/30 text-center shadow-[0_0_40px_rgba(34,211,238,0.1)]">
          ...
          <p className="text-slate-300 mb-8 max-w-xl mx-auto">
            Don't risk losing your data or causing further hardware damage. Let our experts diagnose it today with zero risk.
          </p>
