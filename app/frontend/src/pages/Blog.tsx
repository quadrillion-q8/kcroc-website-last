...
// Canonical Person @id for the real author bio page.
const IMRAN_AUTHOR_ID =
  'https://www.computerrepairkuwait.com/author/imran#person';
...
const EXTRA_GUIDES: ExtraGuideCard[] = [
  ...
  },
  {
    ...
    image:
      '/images/blog/intel-core-ultra-vs-amd-ryzen-ai-comparison.webp',
  ...
  },
  {
    ...
    image:
      '/images/blog/laptop-buying-guide-kuwait-arabic-2026.webp',
...
export default function Blog() {
  /*
   * Build the canonical blog URL without a template literal.
   * This avoids the parser issue reported by Vercel at Blog.tsx:79.
   */
  ...
  const displayPosts: BlogCardItem[] = useMemo(() => {
    ...
    const fromGraph: BlogCardItem[] = EXTRA_GUIDES.flatMap((guide) => {
      const entity = KCROC_GRAPH.pages.find(
        (page) => page.id === guide.entityId
      );
      ...
      '@graph': [
        {
          ...
          description:
            'Expert computer repair guides, laptop fixes, MacBook troubleshooting, and PC performance tips in Kuwait.',
          url: pageUrl,
          isPartOf: {
            '@type': 'WebSite',
      ...
      <section className="relative px-6 text-center mb-20 z-10">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Expert repair guides, troubleshooting tips,
            and hardware insights from Kuwait’s leading
