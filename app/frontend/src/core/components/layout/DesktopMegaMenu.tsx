        ...
        <div className="bg-slate-900 border border-slate-700/60 rounded-2xl shadow-2xl shadow-black/60 overflow-hidden">
          ...
          <div className="p-4 flex items-center justify-between gap-4">
            ...
            <Link
              to="/services"
              onClick={() => setMegaOpen(false)}
              className="shrink-0 text-xs font-bold text-white bg-cyan-500 hover:bg-cyan-400 px-4 py-2 rounded-lg transition-colors flex items-center gap-1.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
            >
