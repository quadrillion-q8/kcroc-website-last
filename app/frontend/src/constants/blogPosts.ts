...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Seeing 85°C, 90°C or higher on your laptop? Learn what CPU and GPU temperatures are normal, when heat becomes a performance problem, and what Kuwait's climate changes.",
    description: "Laptop temperatures in Kuwait explained: practical CPU and GPU temperature ranges for idle, office work, gaming and heavy workloads, plus signs of thermal throttling and when cleaning or thermal service is needed.",
    content: [
    ...
    richContent: [
      ...
      { type: 'h2', text: 'Laptop Temperature Ranges: A Practical Guide', id: 'laptop-temperature-ranges' },
      ...
      { type: 'comparisonTable', title: 'Typical laptop CPU and GPU temperature ranges', columns: ['CPU', 'GPU', 'Interpretation'], rows: [
      ...
      { type: 'image', src: '/images/blog/laptop-temperatures-kuwait-cpu-gpu-cooling.webp', alt: 'Laptop cooling fan and heatsink assembly being inspected in Kuwait', caption: 'The cooling system has to move heat from the CPU and GPU into the heatsink and out through the fan exhaust. Dust and restricted airflow reduce that ability.' },
      ...
      { type: 'image', src: '/images/laptop-cooling-fins-dust-removal-kuwait-1000.webp', alt: 'Dust buildup being removed from laptop cooling fins in Kuwait', caption: 'Blocked heatsink fins restrict the airflow path. Cleaning the fins and fan can restore the cooling system before more invasive repair is considered.' },
      ...
      { type: 'callout', variant: 'recommendation', title: 'Need a diagnosis?', text: "If your laptop is running unusually hot, throttling or becoming noisy, KCROC can inspect the cooling system and determine whether it needs cleaning, thermal service, fan work or deeper laptop repair. Use the site's repair booking or free diagnosis option rather than replacing the laptop based on one temperature reading." },
    ],
