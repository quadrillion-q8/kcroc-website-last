...
const rawGraphData: RawGraphData = {
  ...
  entities: {
    ...
    'usp-logistics': { id: 'usp-logistics', entityType: 'USP', isActive: true, iconKey: 'Truck', title: 'Free Pick & Drop', description: 'We cover Hawalli, Salmiya, Kuwait City, and beyond.' } as USPEntity,
    ...
    'proc-standard': {
      ...
      steps: [
        { step: 1, title: 'Free Collection', description: 'Schedule a pickup via WhatsApp. Our courier collects your device directly from your doorstep.' },
        { step: 2, title: 'Precision Diagnostic', description: 'Your device enters our Hawalli lab where technicians trace the exact component failure.' },
        { step: 3, title: 'Repair & Return', description: 'We execute the micro-soldering, test the system under load, and deliver it safely back to you.' }
      ]
    } as ProcessEntity,
    ...
    'faq-liquid-damage': { id: 'faq-liquid-damage', slug: 'faq-liquid-damage', entityType: 'FAQ', isActive: true, title: 'Do you repair liquid damage?', description: 'Details about our liquid damage process.', answer: 'Yes, we trace circuits to the component level.', seo: { title: 'FAQ', description: 'FAQ', canonicalUrl: '/faq/liquid-damage' } } as FAQEntity,
