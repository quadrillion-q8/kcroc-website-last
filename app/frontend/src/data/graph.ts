...
export const rawGraphData: RawGraphData = {
  ...
  entities: {
    ...
    'guide-battery': { id: 'guide-battery', slug: 'guides/laptop-battery-warning-signs', entityType: 'WebPage', isActive: true, title: 'Laptop Battery Warning Signs', description: 'Learn the 10 critical warning signs of lithium-ion battery failure, how to check battery health on Windows 11 and macOS, and what to do about a swollen battery.', seo: { title: 'Laptop Battery Warning Signs: 10 Signs of a Failing Battery | KCROC', description: 'How can you tell if a laptop battery is failing? Learn 10 warning signs, how to check battery health on Windows 11 and macOS, and what to do about swelling, charging or sudden shutdowns.', canonicalUrl: 'https://www.computerrepairkuwait.com/guides/laptop-battery-warning-signs', ogType: 'article', schemaTypes: ['Article', 'FAQPage'] },
      featuredFAQIds: [
    ...
    'faq-arabic-computer-technician': {
      ...
      title: 'فني كمبيوتر في الكويت — هل يمكن ترتيب الاستلام من المنزل؟',
